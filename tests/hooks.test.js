...
assert.equal(output.systemMessage, undefined, 'Codex must not emit systemMessage — it renders as a yellow warning (#605)');
...
// too — assert the codex branch emits hookSpecificOutput without a systemMessage.
