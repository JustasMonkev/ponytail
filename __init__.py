...
def _fallback_instructions(mode: str) -> str:
    return (
        ...
        "speculative scaffolding. Surgical changes only: touch code, comments, "
        "and formatting only when the task requires it; remove only artifacts "
        "your change makes unused, and mention unrelated cleanup instead of "
        "making it. Deletion over addition. Boring over clever. "
